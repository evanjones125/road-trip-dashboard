...
from apis.weather import is_date_in_range, check_for_precip
...
class WeatherAPITests(TestCase):
    def test_date_in_range(self):
        ...
        self.assertTrue(is_date_in_range("2023-10-25", NWS_payload))
    ...
    def test_date_out_of_range(self):
        ...
        self.assertFalse(is_date_in_range("2023-10-30", NWS_payload))

    def test_check_for_precip_true(self):
        NWS_payload = [
            {
                "number": 1,
                "name": "Today",
        ...
        result = check_for_precip("2023-10-26", NWS_payload)
        self.assertEqual(
            result,
            [
                [
                    "Today",
                    "2023-10-23",
                    "A chance of snow showers after noon. Mostly sunny. High near 36, with temperatures falling to around 34 in the afternoon. South southwest wind 12 to 17 mph. Chance of precipitation is 30%. Little or no snow accumulation expected.",
                ],
                [
                    "Wednesday Night",
                    "2023-10-25",
                    "A chance of snow. Mostly cloudy, with a low around 21. Chance of precipitation is 40%. New snow accumulation of 1 to 2 inches possible.",
                ],
            ],
        )

    def test_check_for_precip_false(self):
        NWS_payload = [
            {
                "number": 1,
                "name": "Today",
                ...
                "icon": "https://api.weather.gov/icons/land/day/sct/snow,30?size=medium",
                "shortForecast": "Mostly Sunny",
                "detailedForecast": "Mostly clear. South southwest wind 12 to 17 mph.",
            },
            {
                "number": 2,
                "name": "Tonight",
            ...
            },
            {
                ...
                "icon": "https://api.weather.gov/icons/land/night/snow,20/snow,40?size=medium",
                "shortForecast": "Mostly clear",
                "detailedForecast": "Mostly cloudy, with a low around 21.",
            },
            {
                "number": 7,
                "name": "Thursday",
    ...
    def test_check_for_precip_date_out_of_range(self):
        NWS_payload = [
            {
                "number": 1,
                "name": "Today",
        ...
        result = check_for_precip("2023-11-04", NWS_payload)
